...
export const newsData = [
  ...
  //   description:
  //     "Join us in making a difference for underprivileged communities. This initiative provides essential resources like food, education, and shelter to those in need. Volunteers are welcome to contribute in various capacities to help build a better and more sustainable world.",
  //   imgSrc:
...
export const languages = [
  ...
  {
    name: "Nyanja",
    description: "Widely spoken in Zambia, expressive, melodic, with a rich cultural heritage.",
  },
  {
    name: "Bemba",
    description: "Predominant Zambian language, vibrant, tonal, reflects community-focused values.",
  }
];

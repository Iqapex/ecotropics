...
const impactMetrics = [
  ...
  { value: '50K+', label: 'Tonnes CO₂ Reduced' },
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
          ...
          >
            Pioneering innovative approaches to protect our planet and create a sustainable future
          </motion.p>
        </div>
      </motion.section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive approaches to environmental challenges through innovation and community engagement
            </p>
          </motion.div>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">{solution.title}</span>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          >
            ...
            <button className="bg-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-700 transition-colors inline-flex items-center">
              Get Started
